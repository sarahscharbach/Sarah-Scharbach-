...
namespace Debugging
{
    ...
    public class Familytree
    {
        public static Person Find(Person person)
        {
         ...
         public static Person FindPersonByAge(Person person, int min_age, int max_age)
        {
            Person ret = null;
            ...
            if (age >= min_age && age <= max_age)
                return person; 
            if(person.Mom != null)
                ret = FindPersonByAge(person.Mom, min_age, max_age);
            if (ret != null)
                return ret;
            if(person.Dad != null)
                ret = FindPersonByAge(person.Dad, min_age, max_age);
            return ret;
        }
